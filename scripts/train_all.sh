...
python train.py --dataset Hippocorpus --prog_steps null-0.25-full --first_model bart
python train.py --dataset Hippocorpus --prog_steps null-0.2-0.25-full --first_model bart
python train.py --dataset Hippocorpus --prog_steps null-full --first_model gpt2
python train.py --dataset Hippocorpus --prog_steps null-full --first_model bart
